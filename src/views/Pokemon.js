...
import { Row, Col, Image, Badge, ProgressBar, Card } from 'react-bootstrap';
        ...
        <>
          ...
          <Row className='content'>
            <Col xs={12} lg={6} className='img'>
              <div
                className={data?.types[0]?.type?.name + '-bg h-100'}
              >
                <Image
                  className='p-3'
                  src={handleImg(data?.sprites?.other?.home?.front_default)}
